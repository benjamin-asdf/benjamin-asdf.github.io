...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k37864,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__37882 = k37864;
var G__37882__$1 = (((G__37882 instanceof cljs.core.Keyword))?G__37882.fqn:null);
switch (G__37882__$1) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37864,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__37890){
var vec__37892 = p__37890;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37892,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37892,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37865,other37866){
var self__ = this;
var this37865__$1 = this;
return (((!((other37866 == null)))) && ((((this37865__$1.constructor === other37866.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37865__$1.value,other37866.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37865__$1.string_value,other37866.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37865__$1.__extmap,other37866.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k37864){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37864);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__37863){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__37935 = cljs.core.keyword_identical_QMARK_;
var expr__37936 = k__4511__auto__;
if(cljs.core.truth_((pred__37935.cljs$core$IFn$_invoke$arity$2 ? pred__37935.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__37936) : pred__37935.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__37936)))){
return (new rewrite_clj.node.token.TokenNode(G__37863,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37935.cljs$core$IFn$_invoke$arity$2 ? pred__37935.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__37936) : pred__37935.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__37936)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__37863,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__37863),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__37863){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__37863,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__37868){
var extmap__4542__auto__ = (function (){var G__37957 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37868,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__37868)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__37957);
} else {
return G__37957;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__37868),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__37868),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
