...
var G__39370 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__39370;
continue;
} else {
var G__39371 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__39371;
continue;
}
} else {
var G__39372 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__39372;
continue;
}
}
...
var G__39343 = zloc;
var G__39344 = (function (){var G__39345 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__39347 = zloc;
var G__39347__$1 = (((G__39347 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__39347) : rewrite_clj.zip.node.call(null,G__39347)));
if((G__39347__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39347__$1) : zprint.zutil.edn_STAR_.call(null,G__39347__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__39345) : rewrite_clj.zip.root.call(null,G__39345));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__39343,G__39344) : rewrite_clj.zip.replace.call(null,G__39343,G__39344));
});
/**
...
var G__39386 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__39386;
continue;
}
break;
...
var G__39388 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__39389 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__39388;
out = G__39389;
continue;
} else {
...
var G__39391 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__39392 = cljs.core.next(new_loc);
var G__39393 = replaced_loc;
nloc = G__39391;
new_loc = G__39392;
last_loc = G__39393;
continue;
...
return zprint.rewrite.sort_val((function (){var G__39359 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__39359) : rewrite_clj.zip.down.call(null,G__39359));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__39362_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__39362_SHARP_) : rewrite_clj.zip.tag.call(null,p1__39362_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__39362_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__39362_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
