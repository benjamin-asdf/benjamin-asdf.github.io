...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__38109 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38109) : f.call(null,G__38109));
})(),sq);
});
...
var comma_38170 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_38171 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__38123){
var vec__38130 = p__38123;
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_38171,rewrite_clj.node.protocols.coerce(v),comma_38170], null);
