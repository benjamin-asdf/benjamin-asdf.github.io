...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37307_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37307_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37307_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37309){
var vec__37310 = p__37309;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37310,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37310,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37313,s,color,element,idx){
var map__37314 = p__37313;
var map__37314__$1 = cljs.core.__destructure_map(map__37314);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37314__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37314__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37314__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__37317 = (function (){var or__4253__auto__ = color;
...
var fexpr__37316 = (function (){var G__37318 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__37318) : style_map.call(null,G__37318));
})();
return (fexpr__37316.cljs$core$IFn$_invoke$arity$1 ? fexpr__37316.cljs$core$IFn$_invoke$arity$1(G__37317) : fexpr__37316.call(null,G__37317));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37319){
var vec__37320 = p__37319;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37320,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37320,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37320,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37324){
var vec__37325 = p__37324;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37325,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37325,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37325,(2),null);
...
var G__37424 = cljs.core.next(ssv);
var G__37425 = (this_ssv == null);
var G__37426 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__37346 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37346,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37346,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37346,(2),null);
...
var G__37429 = cljs.core.next(remaining_cvec);
var G__37430 = new_idx;
var G__37431 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__37429;
idx = G__37430;
out = G__37431;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__37378,cursor_vec){
var vec__37379 = p__37378;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37379,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37379,(1),null);
var focus_vec = vec__37379;
...
var vec__37382 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37382,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37382,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__37385){
var vec__37386 = p__37385;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37386,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37386,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37393,existing_count){
var vec__37394 = p__37393;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37394,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37394,(1),null);
...
return cljs.core.filterv((function (p1__37389_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__37389_SHARP_))));
...
var vec__37403 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37403,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37403,(1),null);
var cvec_element = vec__37403;
if((cvec_element == null)){
var G__37455 = cljs.core.next(cvec_nl);
var G__37456 = (idx + (1));
var G__37457 = start;
var G__37458 = out;
cvec_nl = G__37455;
...
var G__37459 = cljs.core.next(cvec_nl);
var G__37460 = (idx + (1));
var G__37461 = idx;
var G__37462 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37459;
idx = G__37460;
start = G__37461;
out = G__37462;
...
var G__37463 = cljs.core.next(cvec_nl);
var G__37464 = (idx + (1));
var G__37465 = (idx + (1));
var G__37466 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37463;
idx = G__37464;
start = G__37465;
out = G__37466;
...
var G__37468 = cljs.core.next(cvec_nl);
var G__37469 = (idx + (1));
var G__37470 = idx;
var G__37471 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37468;
idx = G__37469;
start = G__37470;
out = G__37471;
...
var G__37472 = cljs.core.next(cvec_nl);
var G__37473 = (idx + (1));
var G__37474 = start;
var G__37475 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37472;
idx = G__37473;
start = G__37474;
out = G__37475;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37408_SHARP_,p2__37407_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__37407_SHARP_)){
return cljs.core.reduced(p1__37408_SHARP_);
} else {
return (p1__37408_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37409,p__37410){
var vec__37411 = p__37409;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37411,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37411,(1),null);
var vec__37414 = p__37410;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37414,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37414,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37419,cvec,focus_vec){
var map__37420 = p__37419;
var map__37420__$1 = cljs.core.__destructure_map(map__37420);
var options = map__37420__$1;
var map__37421 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37420__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__37421__$1 = cljs.core.__destructure_map(map__37421);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37421__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37421__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37421__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37418_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__37418_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
