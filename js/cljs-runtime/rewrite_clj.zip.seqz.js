...
var G__38648 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__38648__$1 = (((G__38648 == null))?null:cljs.core.iterate((function (loc){
...
var G__38648__$2 = (((G__38648__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38648__$1));
var G__38648__$3 = (((G__38648__$2 == null))?null:cljs.core.last(G__38648__$2));
if((G__38648__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__38648__$3);
}
} else {
return zloc;
}
...
var G__38681 = rewrite_clj.zip.move.right(v);
var G__38682 = rewrite_clj.zip.move.up(v);
loc = G__38681;
parent = G__38682;
continue;
} else {
var G__38683 = rewrite_clj.zip.move.right(v0);
var G__38684 = parent;
loc = G__38683;
parent = G__38684;
continue;
...
var G__38685 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__38686 = rewrite_clj.zip.move.up(v);
loc = G__38685;
parent = G__38686;
continue;
} else {
var G__38687 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__38688 = parent;
loc = G__38687;
parent = G__38688;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__38659 = zloc;
var G__38659__$1 = (((G__38659 == null))?null:rewrite_clj.zip.move.down(G__38659));
var G__38659__$2 = (((G__38659__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__38659__$1,k));
if((G__38659__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__38659__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__38661 = rewrite_clj.zip.move.down(zloc);
var G__38661__$1 = (((G__38661 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__38661));
if((G__38661__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38661__$1);
}
})(),k);
}
});
