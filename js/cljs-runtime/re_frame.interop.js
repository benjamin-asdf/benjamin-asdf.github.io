...
return [(function (){var pred__35035 = cljs.core.instance_QMARK_;
var expr__35036 = reactive_val;
if(cljs.core.truth_((pred__35035.cljs$core$IFn$_invoke$arity$2 ? pred__35035.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__35036) : pred__35035.call(null,reagent.ratom.RAtom,expr__35036)))){
return "ra";
} else {
if(cljs.core.truth_((pred__35035.cljs$core$IFn$_invoke$arity$2 ? pred__35035.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__35036) : pred__35035.call(null,reagent.ratom.RCursor,expr__35036)))){
return "rc";
} else {
if(cljs.core.truth_((pred__35035.cljs$core$IFn$_invoke$arity$2 ? pred__35035.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__35036) : pred__35035.call(null,reagent.ratom.Reaction,expr__35036)))){
return "rx";
} else {
if(cljs.core.truth_((pred__35035.cljs$core$IFn$_invoke$arity$2 ? pred__35035.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__35036) : pred__35035.call(null,reagent.ratom.Track,expr__35036)))){
return "tr";
} else {
return "other";
}
