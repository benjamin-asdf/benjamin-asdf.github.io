...
return [(function (){var pred__31323 = cljs.core.instance_QMARK_;
var expr__31324 = reactive_val;
if(cljs.core.truth_((pred__31323.cljs$core$IFn$_invoke$arity$2 ? pred__31323.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__31324) : pred__31323.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__31324)))){
return "ra";
} else {
if(cljs.core.truth_((pred__31323.cljs$core$IFn$_invoke$arity$2 ? pred__31323.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__31324) : pred__31323.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__31324)))){
return "rc";
} else {
if(cljs.core.truth_((pred__31323.cljs$core$IFn$_invoke$arity$2 ? pred__31323.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__31324) : pred__31323.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__31324)))){
return "rx";
} else {
if(cljs.core.truth_((pred__31323.cljs$core$IFn$_invoke$arity$2 ? pred__31323.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__31324) : pred__31323.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__31324)))){
return "tr";
} else {
return "other";
}
