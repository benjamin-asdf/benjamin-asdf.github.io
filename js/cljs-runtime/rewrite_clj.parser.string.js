...
if((c === "\n")){
var G__38195 = escape_QMARK_;
var G__38196 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__38195;
lines = G__38196;
continue;
} else {
buf.append(c);

var G__38197 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__38198 = lines;
escape_QMARK_ = G__38197;
lines = G__38198;
continue;
...
var G__38192 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__38192) : rewrite_clj.node.string_node.call(null,G__38192));
});
...
var G__38193 = cljs.core.re_pattern(regex);
var G__38194 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__38193,G__38194) : rewrite_clj.node.token_node.call(null,G__38193,G__38194));
});
