 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__32151){
var vec__32152 = p__32151;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32152,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32152,(1),null);
return (function (s){
...
var len__4864__auto___32183 = arguments.length;
var i__4865__auto___32184 = (0);
while(true){
if((i__4865__auto___32184 < len__4864__auto___32183)){
args__4870__auto__.push((arguments[i__4865__auto___32184]));

var G__32189 = (i__4865__auto___32184 + (1));
i__4865__auto___32184 = G__32189;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__32158_SHARP_){
return (p1__32158_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__32158_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__32158_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq32160){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq32160));
}));
...
var map__32174 = temp__5751__auto__;
var map__32174__$1 = cljs.core.__destructure_map(map__32174);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32174__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32174__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32174__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__32191 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__32192 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__32177 = tag;
