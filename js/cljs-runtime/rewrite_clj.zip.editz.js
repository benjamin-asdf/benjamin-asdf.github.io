...
var G__38543 = (function (){var G__38545 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38545) : f.call(null,G__38545));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__38543) : rewrite_clj.node.coerce.call(null,G__38543));
});
/**
...
var len__4864__auto___38605 = arguments.length;
var i__4865__auto___38606 = (0);
while(true){
if((i__4865__auto___38606 < len__4864__auto___38605)){
args__4870__auto__.push((arguments[i__4865__auto___38606]));

var G__38607 = (i__4865__auto___38606 + (1));
i__4865__auto___38606 = G__38607;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__38547_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__38547_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq38548){
var G__38549 = cljs.core.first(seq38548);
var seq38548__$1 = cljs.core.next(seq38548);
var G__38550 = cljs.core.first(seq38548__$1);
var seq38548__$2 = cljs.core.next(seq38548__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38549,G__38550,seq38548__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38568 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38568) : str_fn.call(null,G__38568));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38569 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38569) : str_fn.call(null,G__38569));
})()):null)));
...
var G__38578 = rewrite_clj.zip.base.tag(zloc);
var G__38578__$1 = (((G__38578 instanceof cljs.core.Keyword))?G__38578.fqn:null);
switch (G__38578__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38573_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38573_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__38575_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38575_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38578__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__38580 = rewrite_clj.zip.base.tag(zloc);
var G__38580__$1 = (((G__38580 instanceof cljs.core.Keyword))?G__38580.fqn:null);
switch (G__38580__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38579_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38579_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38580__$1)].join('')));
