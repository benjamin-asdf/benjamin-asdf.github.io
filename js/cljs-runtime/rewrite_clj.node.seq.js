...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k37676,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__37689 = k37676;
var G__37689__$1 = (((G__37689 instanceof cljs.core.Keyword))?G__37689.fqn:null);
switch (G__37689__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37676,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__37701){
var vec__37703 = p__37701;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37703,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37703,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37677,other37678){
var self__ = this;
var this37677__$1 = this;
return (((!((other37678 == null)))) && ((((this37677__$1.constructor === other37678.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37677__$1.tag,other37678.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37677__$1.wrap_fn,other37678.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37677__$1.wrap_length,other37678.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37677__$1.seq_fn,other37678.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37677__$1.children,other37678.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37677__$1.__extmap,other37678.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__37745 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__37745) : self__.seq_fn.call(null,G__37745));
}));
...
var self__ = this;
var this$__$1 = this;
var G__37758 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__37758) : self__.wrap_fn.call(null,G__37758));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k37676){
var self__ = this;
var this__4509__auto____$1 = this;
var G__37819 = k37676;
var G__37819__$1 = (((G__37819 instanceof cljs.core.Keyword))?G__37819.fqn:null);
switch (G__37819__$1) {
case "tag":
case "wrap-fn":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37676);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__37675){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__37824 = cljs.core.keyword_identical_QMARK_;
var expr__37825 = k__4511__auto__;
if(cljs.core.truth_((pred__37824.cljs$core$IFn$_invoke$arity$2 ? pred__37824.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37825) : pred__37824.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37825)))){
return (new rewrite_clj.node.seq.SeqNode(G__37675,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37824.cljs$core$IFn$_invoke$arity$2 ? pred__37824.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__37825) : pred__37824.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__37825)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__37675,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37824.cljs$core$IFn$_invoke$arity$2 ? pred__37824.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__37825) : pred__37824.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__37825)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__37675,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37824.cljs$core$IFn$_invoke$arity$2 ? pred__37824.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__37825) : pred__37824.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__37825)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__37675,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37824.cljs$core$IFn$_invoke$arity$2 ? pred__37824.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__37825) : pred__37824.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37825)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__37675,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__37675),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__37675){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__37675,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__37680){
var extmap__4542__auto__ = (function (){var G__37844 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37680,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__37680)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__37844);
} else {
return G__37844;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__37680),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__37680),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__37680),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__37680),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37680),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__37849_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__37849_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__37873_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__37873_SHARP_);
}),children);
});
