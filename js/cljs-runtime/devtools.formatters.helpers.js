...
var G__28263 = devtools.prefs.pref(v);
v = G__28263;
continue;
} else {
return v;
...
}catch (e28161){var _e__27066__auto__ = e28161;
return false;
}})();
...
}catch (e28173){var _e__27066__auto__ = e28173;
return false;
}})();
...
}catch (e28179){var _e__27066__auto__ = e28179;
return false;
}}
}
});
...
var vec__28220 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28220,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28220,(1),null);
...
return cljs.core.some((function (p1__28228_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28228_SHARP_);
}),template);
});
